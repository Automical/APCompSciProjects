...
public class EasyComp extends World<Piece>
{
   ...
   {
      EasyComp world = new EasyComp(7, 7);
      world.show();
   }
   
   public EasyComp(int rows, int cols)
   {
   ...
   public boolean locationClicked(Location loc)
   {
      ...
      Location compLoc = game.dropLocationForColumn(gen.nextInt(7));
      if (!gameOver) {
          flipTurn();
